...
class ColorDeltaEMetric(BaseReferenceMetric):
    ...
    GRID_ROWS = 3          # Количество строк в сетке (например, 1 или 2)
    ...
    [55.78, 0.12, 10.83],  # Искаженный Патч 18 (Реальная dE: 7.22)
    [86.29, -5.71, 13.52],  # Искаженный Патч 17 (Реальная dE: 7.67)
    [51.34, 0.4299, -22.12],  # Искаженный Патч 16 (Реальная dE: 7.34)
    [44.68, -7.759, -26.34],  # Искаженный Патч 15 (Реальная dE: 7.33)
    [59.10, 5.269, -12.26],  # Искаженный Патч 14 (Реальная dE: 7.46)
    [61.36, -20.25, 22.51],  # Искаженный Патч 13 (Реальная dE: 7.51)
    [65.04, 1.090, 28.52],  # Искаженный Патч 12 (Реальная dE: 7.15)
    [72.70, -14.77, -5.759],  # Искаженный Патч 11 (Реальная dE: 7.18)
    [61.64, 14.6, 6.29],  # Искаженный Патч 10 (Реальная dE: 7.13)
    [45.90, -5.71, -10.4],  # Искаженный Патч 9 (Реальная dE: 7.63)
    [67.20, -17.26, 21.84],  # Искаженный Патч 8 (Реальная dE: 7.88)
    [69.56, 3.04, 43.10],  # Искаженный Патч 7 (Реальная dE: 7.84)
    [67.79, -5.910, -16.10],  # Искаженный Патч 6 (Реальная dE: 7.76)
    [70.20, -19.07, 13.92],  # Искаженный Патч 5 (Реальная dE: 7.53)
    [64.76, 6.240, 19.16],  # Искаженный Патч 4 (Реальная dE: 7.10)
    [76.29, -1.409, 53.10],  # Искаженный Патч 3 (Реальная dE: 7.68)
    [62.57, 8.820, 17.98],  # Искаженный Патч 2 (Реальная dE: 7.36)
    [66.87, -13.03, -1.71]  # Искаженный Патч 1 (Реальная dE: 7.36)
]
